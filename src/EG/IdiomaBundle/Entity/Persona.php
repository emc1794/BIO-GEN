 ...
 * @ORM\Entity(repositoryClass="EG\Idioma\Repository\PersonaRepository")
 * @UniqueEntity(
 *     fields={"ci"},
 *     errorPath="ci",
...
class Persona
{
     ...
     * Set usuario
     *
     * @param \EG\IdiomaBundle\Entity\Usuario $usuario
     *
     * @return Persona
     */
    public function setUsuario(\EG\IdiomaBundle\Entity\Usuario $usuario = null)
    {
     ...
     * Get usuario
     *
     * @return \EG\IdiomaBundle\Entity\Usuario
     */
