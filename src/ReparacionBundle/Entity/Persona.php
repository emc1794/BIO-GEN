 ...
 * @ORM\Entity(repositoryClass="ReparacionBundle\Repository\PersonaRepository")
 * @UniqueEntity(
 *     fields={"ci"},
 *     errorPath="ci",
...
class Persona
{
     ...
     * Set usuario
     *
     * @param \ReparacionBundle\Entity\Usuario $usuario
     *
     * @return Persona
     */
    public function setUsuario(\ReparacionBundle\Entity\Usuario $usuario = null)
    {
     ...
     * Get usuario
     *
     * @return \ReparacionBundle\Entity\Usuario
     */
