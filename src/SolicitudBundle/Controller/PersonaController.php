...
use SolicitudBundle\Entity\Persona;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personas = $em->getRepository('SolicitudBundle:Persona')->findAll();
    ...
    {
        $persona = new Persona();
        $form = $this->createForm('SolicitudBundle\Form\PersonaType', $persona);
    ...
    {
        $deleteForm = $this->createDeleteForm($persona);
        $editForm = $this->createForm('SolicitudBundle\Form\PersonaType', $persona);
