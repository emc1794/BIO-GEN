...
use TotaisBundle\Entity\Categoria;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categorias = $em->getRepository('TotaisBundle:Categoria')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('TotaisBundle\Form\CategoriaType', $categorium);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorium);
        $editForm = $this->createForm('TotaisBundle\Form\CategoriaType', $categorium);
