 ...
 * @ORM\Entity(repositoryClass="TotaisBundle\Repository\PersonaRepository")
 * @UniqueEntity(
 *     fields={"ci"},
 *     errorPath="ci",
...
class Persona
{
     ...
     * Set usuario
     *
     * @param \TotaisBundle\Entity\Usuario $usuario
     *
     * @return Persona
     */
    public function setUsuario(\TotaisBundle\Entity\Usuario $usuario = null)
    {
     ...
     * Get usuario
     *
     * @return \TotaisBundle\Entity\Usuario
     */
